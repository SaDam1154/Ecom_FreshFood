...
function CardSection({ img, discount, title, content }) {
    return (
        <div className='flex relative flex-col justify-start items-start w-full h-full'>
            <img src={img} alt='Banner' className='absolute rounded-xl object-cover -z-0 left-0  top-0 w-[95%] h-full' />
            <div className='z-10 flex flex-col gap-3 w-[60%]'>
                ...
                <div>
                    <Link to='/products'>
                        <button className='flex gap-2 lg:ml-2 xl:ml-2 2xl:ml-10 text-base font-semibold relative overflow-hidden rounded-md bg-transparent text-white px-6 pt-8 pb-2  '>
