...
function Home() {
    return (
        <div className="flex flex-col w-full h-auto px-[8vw] overflow-scroll items-center justify-start">
            <Sidebar></Sidebar>
            {/* Khu hình ảnh ban đầu */}
            <div className="grid grid-cols-1 lg:grid-cols-3 h-[35vw] min-h-fit w-full  gap-8  items-center justify-between">
                ...
                <div className="flex relative col-span-2 flex-col justify-center items-start px-[2vw] h-full w-full">
                    ...
                    <div className="z-10 flex flex-col gap-3 w-[60%]">
                        ...
                        <div>
                            <p className="w-[75%] text-[#4a5568] text-sm font-normal">
                ...
                {/* Khung 2 hình nhỏ */}
                <div className="hidden lg:flex relative flex-col justify-center items-start w-full h-full gap-3">
                    <div className="flex relative flex-col justify-center items-start px-20 h-full w-full">
                        ...
                        <div className="z-10 flex flex-col gap-3">
                            <h2 className="text-5xl text-[#ff4f4f] cursor-hover">
            ...
            {/* khu 3 */}
            <div className="flex flex-col h-[500px] w-full bg-red-500 z-20">121312312323</div>
        </div>
    );
}
