...
function Home() {
    return (
        <div className='flex flex-col w-full h-auto px-[8vw] overflow-y-scroll overflow-x-hidden items-center justify-start'>
            <Sidebar></Sidebar>
            ...
            <div className='w-full h-full grid grid-cols-1 lg:grid-cols-4'>
                {/* khu Category */}
                <div className='flex flex-col bg-slate-100 rounded-2xl p-4 mx-10'>
                ...
                {/* khu Category */}
                <div className='col-span-3'>Top Sales</div>
            </div>
