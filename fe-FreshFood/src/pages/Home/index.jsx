        ...
        <div className="flex flex-col w-full h-auto px-8 sm:px-12 lg:px-20 xl:px-28 overflow-y-scroll overflow-x-hidden items-center justify-start">
                    ...
                    <div className="z-10 flex flex-col gap-3 xl:gap-10 2xl:gap-8 w-[60%]">
                        ...
                        <div>
                            <h1 className="uppercase text-[#4a5568] text-xl sm:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-semibold cursor-hover">
                                ...
                                <span className="cursor-hover text-[#0da487] font-extrabold">Daily Needs</span>
                            </h1>
                        </div>
                        <div>
                ...
                <div className="hidden lg:flex relative flex-col justify-start items-start w-full h-full gap-2 lg:gap-4 2xl:gap-6">
                    <div className="flex relative flex-col justify-center items-start px-5 h-full w-full">
                        ...
                        <div className="z-10 flex flex-col gap-3">
                            ...
                            <h3 className="text-[28px] text-[#0da487] font-bold cursor-hover">Nut Collection</h3>
                            <span className="text-[#4a5568] w-3/5">We deliver organic vegetables {'&'} fruits</span>
                    ...
                    <div className="flex relative flex-col justify-center items-start px-5 h-full w-full">
                        ...
                        <div className="z-10 flex flex-col gap-3">
                            <h3 className="text-[28px] text-[#0da487] font-bold cursor-hover">Healthy Food</h3>
                            <h2 className="text-[20px] text-[#ff4f4f] font-semibold cursor-hover">Healthy Food</h2>
                            <span className="text-[#4a5568] w-3/5">
                                <p class="organic cursor-hover">Start your daily shopping with some Organic food</p>
                            </span>
                            <button className="text-red  relative overflow-hidden  rounded-md bg-transparent  text-[#222222]  ">
                                <div className="flex items-center justify-start relative z-10 gap-4 text-sm sm:text-base lg:text-base xl:text-lg 2xl:text-xl ">
                                    <span>Shop Now</span>
            ...
            <div className="w-full h-full grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4">
                ...
                <div className="flex flex-col gap-8 sm:col-span-2 lg:col-span-3">
                    <div className="flex flex-col">
                        <div className="flex flex-col gap-1 w-full items-end justify-center">
                            ...
                            <span className="text-[#4a5568]">
                                Don't miss this opportunity at a special product just for you.
                            </span>
                        </div>
                    ...
                    <div className="flex flex-col">
                        <div className="flex flex-col gap-1 w-full items-end justify-center">
                            <span className="text-neutral-900 text-3xl font-semibold">Top Sales Today</span>
                            <hr class=" bg-green-400 w-48 h-1 border-0 rounded" />
