...
function Rating({ rating, isOwn = false, onDelete, onEdit }) {
    return (
        <div className="flex space-x-4 rounded-md border-b py-3">
            <img
                className="h-[74px] w-[74px] rounded-md border"
            ...
            {isOwn && (
                <div className="space-y-2">
                    <button
                        className="flex items-center space-x-2 font-semibold text-orange-400"
                        onClick={onEdit}
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <button
                        className="flex items-center space-x-2 font-semibold text-red-500"
                        onClick={onDelete}
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
...
function StarInput({ score, setScore }) {
    return (
        <div className="flex items-center space-x-3">
            ...
            {score > 0 && (
                <button className="font-semibold text-red-500" onClick={() => setScore(0)}>
                    Huỷ
                </button>
            )}
        </div>
...
export default function RatingsBlock({ product, onChange }) {
    ...
    return (
        <div className="mt-10">
            ...
            <div className="mt-3 w-[500px] space-y-1">
            ...
            <div className="mt-6">
                {customer ? (
                    !ownRating || isEdit ? (
                        <div className="mt-3">
                            <div className="flex space-x-4 rounded-md py-3">
                                <img
                                    className="h-[74px] w-[74px] rounded-md border"
                                ...
                                <div className="flex-1 space-y-1">
                                    ...
                                    <textarea
                                        type="text"
                                        className={clsx('text-input !mt-3 h-auto w-full py-2', {})}
                                    ...
                                    {score > 0 && (
                                        <button
                                            className="btn btn-md w-full bg-primary-600 hover:bg-primary-700"
                                            onClick={() =>
