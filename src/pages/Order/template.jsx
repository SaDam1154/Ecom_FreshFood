            ...
            <body>
                <div className="container">
                    ...
                    <div className="header">
                        <h1>
                            <span className="name">FreshFood Shop</span> xin cảm ơn quý khách!
                        </h1>
                    </div>
                    <div className="thanks">
                        Chúng tôi rất trân trọng sự ủng hộ của bạn. Hy vọng bạn sẽ hài lòng với sản
                        phẩm của chúng tôi. Hiện đơn hàng đang ở trạng thái{' '}
                        <span className="boldText">"{template?.status}"</span>. Nếu có bất kỳ vấn đề
                        gì, xin vui lòng liên hệ với chúng tôi để được hỗ trợ.
                    </div>
                    ...
                    <div className="content">
                        ...
                        <div className="invoice-info">
                            ...
                            <table>
                                ...
                                <tbody>
                                    {template?.orderProduct?.details.map((product, index) => (
                                        <tr key={index}>
                                    ...
                                    <tr className="total-row highlight">
                                        ...
                                        <th className="totalPrice">
                                            <PriceFormat>{template?.order?.totalPrice}</PriceFormat>{' '}
                                            VND
                                        </th>
                                    </tr>
                                    <tr className="total-row highlight">
                                        ...
                                        <th className="discountMoney">
                                            <PriceFormat>
                                                {template?.order?.totalPrice -
                                                    template?.order?.intoMoney}
                                            </PriceFormat>{' '}
                                            VND
                                        </th>
                                    </tr>
                                    <tr className="total-row highlight">
                                        ...
                                        <th className="intoMoney">
                                            <PriceFormat>{template?.order?.intoMoney}</PriceFormat>{' '}
                                            VND
                                        </th>
                                    </tr>
                                    <tr className="total-row highlight">
